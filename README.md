...
| `libs/privacy/` | **Privacy engineering** — differential privacy/masking/k-anonymity/clinical date shifting/de-identification assessment | privacy (dp_count/dp_sum/dp_mean, dp_compose/dp_alloc/dp_budget, mask, mask_cn, dateshift, kanon, kanon_report) |
