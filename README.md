...
| `libs/parser/` | **Parsers** — data structures / text (JSON/YAML/XML/TOML/INI/Markdown/EPUB/logs…) | json (vendored rxi/json.lua), yaml, xml, tomlini, markdown, epub, zip_list, unzip, id3 |
| `libs/udf/` | **Scalar UDFs** — algorithms / encodings / math / string / QR | base64, crc32, uuid, html_escape, iconv, cncheck, fuzzy, tail_file, qr, llm_extract |
