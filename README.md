...
| `libs/parser/` | **Parsers** — data structures / text (JSON/YAML/XML/TOML/INI/Markdown/RSS/EPUB/logs…) | json (vendored rxi/json.lua), yaml, xml, tomlini, markdown, jsonpatch, rss, epub, zip_list, unzip, id3 |
