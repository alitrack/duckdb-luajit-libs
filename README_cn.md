...
| `libs/privacy/` | **隐私工程**——差分隐私/脱敏/k-匿名/临床日期平移/去标识化效果评估/自由文本 PHI 脱敏 | privacy（dp_count/dp_sum/dp_mean、dp_compose/dp_alloc/dp_budget、mask、mask_cn、dateshift、redact_text、kanon、kanon_report） |
